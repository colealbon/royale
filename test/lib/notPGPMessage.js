...
suite('notPGPMessage', function() {
    test('notPGPMessage throws "empty content" if content empty', function testnotPGPMessage() {
        const content = '';
        return notPGPMessage(openpgp)('')
    ...
    test('notPGPMessage throws "undefined content" if content undefined', function testnotPGPMessage() {
        return notPGPMessage(openpgp)()
        .then(testResult => {
            assert.notEqual(1, 1);
        })
    ...
    test('notPGPMessage throws "missing openpgp" if not called with openpgp', function testnotPGPMessage() {
...
//     test('notPGPMessage returns content if content is PGP Message', function testnotPGPMessage() {
//         const testContent = `
// -----BEGIN PGP MESSAGE-----
//
...
// =rfvU
// -----END PGP MESSAGE-----`
//         return notPGPMessage(openpgp)(testContent)
//         .then((content) => {
...
//     test('notPGPMessage returns content if content is PGP Private Key', function testnotPGPMessage() {
//         const testContent = `
...
//         })
//     });
//     test('notPGPMessage throws "PGP Pubkey content" if content is PGP Public Key', function testnotPGPMessage() {
//         const testContent = `
...
//     });
//
//     test('notPGPMessage returns content if content is not PGP Content', function testnotPGPMessage() {
//         let content = '123456789';
//         return notPGPMessage(openpgp)(content)
//         .then(testResult => {
